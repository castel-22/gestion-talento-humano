...
class AttendancesExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithDrawings, WithCustomStartCell, WithEvents
{
    protected $filters;
    ...
    */
    public function collection()
    {
        ...
        if (!empty($this->filters['period'])) {
            $date = Carbon::parse($this->filters['period']);
    ...
    */
    public function map($attendance): array
    {
        return [
            ...
            $attendance->employee->id_number,
            $attendance->employee->full_name,
            $attendance->date ? $attendance->date->format('d/m/Y') : 'N/A',
            $attendance->check_in ? Carbon::parse($attendance->check_in)->format('H:i:s') : 'N/A',
            $attendance->check_out ? Carbon::parse($attendance->check_out)->format('H:i:s') : 'N/A',
            $attendance->notes ?? ''
        ];
    }
